    ...
    return (
      <div>
        ...
        <div id="loadingIndicator" class="center hide"
          ...
          <div class="loader-text text-white" id="通用场景"></div>
        </div>
          ...
          <div class="column-17">
            <div class="card card-wide">
              ...
              <div class="card-content">
                <h4 class="trailer-half">交互式大学校园规划</h4>
                <p class="font-size--1 trailer-half">
                  <ul>
                    <li>创建形状时，双击或按下 <code>C</code> 去完成.</li>
                    <li>按下 <code>Del</code> 或者 <code>Backspace</code> 去选择其他项目.</li>
                    <li>按下 <code>Escape</code> 还原当前编辑.</li>
                  </ul>
                </p>
                <div menu>
                  <button class="menu-item btn"
                    onclick={ () => this.timeline.playIntroAnimation() }>开始规划</button>
                  <button class="menu-item btn btn-transparent"
                    onclick={ () => this.timeline.startPlanning() }>跳过动画</button>
                </div>
              </div>
            </div>
          </div>
